...
def calculate_safety_score(token_data, security_data, price_data, overview_data, api_calls):
    score = 100
...
def get_birdeye_data(endpoint, params=None, retries=3):
    headers = {
...
def extract_token_list(api_response):
